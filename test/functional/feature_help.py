...
"""Verify that starting bzetcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bzetcoin with -h for help text")
        ...
        self.log.info("Start bzetcoin with -version for version information")
        ...
        self.log.info("Start bzetcoind with -fakearg to make sure it does not start")
