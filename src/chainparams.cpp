...
{
    const char* pszTimestamp = "Stocks struggle after the Fed eases up on rate hikes/CNN/14DEC2022";
    const CScript genesisOutputScript = CScript() << ParseHex("042c4f53993d12c3de35f4cc041288af759d3192af6b31dddc4a3618a99901c69aee5d84828b424b550ff1393add3c64adc3d5b04e7c369ef4d56c6fc3782a7680") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.MinBIP9WarningHeight = 15; // segwit activation height + miner confirmation window
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nStartHeight = 9999999999;
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nTimeoutHeight = 999999999999;

        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000000000001200120");
        consensus.defaultAssumeValid = uint256S("0x988bad727e13e1fd7dc31571d95d12733801916a8561d4c09b416c4e892c07ff"); // 15
        ...
        genesis = CreateGenesisBlock(1671065465, 450863, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x311eb431de431c490dff5a3ad30db8749d115c6b6d7d5cda457194a54ad4be38"));
        assert(genesis.hashMerkleRoot == uint256S("0xf5a4a30759ab0fd25be332231c1259b1adefe4a70e7cedba1a7bb6a724536bad"));
        ...
        vSeeds.emplace_back("dnsseed1.bzetcoin.com");
        vSeeds.emplace_back("dnsseed1.bzetmex.com");
        ...
        checkpointData = {
            {
		{  2, uint256S("0x442e98b5bc37aad59f6f8784a662e1707418a69d5a9e5dfa899676807cd5e03e")},
		{  5, uint256S("0xd8e6505527cd372a60a92688a1f3c0852b057f4a088c6e0cf2167325a2f4256c")},
		{  19, uint256S("0xab485560f21a0c55e7188c5e62449b2d65651b1bf5430bfded69e2bb0e71429b")}
            }
        };
...
public:
    CTestNetParams() {
        ...
        // Deployment of MWEB (LIP-0002, LIP-0003, and LIP-0004)
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].bit = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nStartHeight = 999999999;
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nTimeoutHeight = 99999999999;
        ...
        genesis = CreateGenesisBlock(1671065466, 7886, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x56f43598702f088f529930e2295a8b2881f150c796c2bdfbd53b266ddcd7e194"));
        assert(genesis.hashMerkleRoot == uint256S("0xf5a4a30759ab0fd25be332231c1259b1adefe4a70e7cedba1a7bb6a724536bad"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-dnsseed.bzetcoin.com");
        vSeeds.emplace_back("testnet-dnsseed.bzetmex.com");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].bit = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nStartTime = 999999999;
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nTimeout = 99999999999;
        ...
        genesis = CreateGenesisBlock(1671065465, 4, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1e724eafb413fdbcc405ff0ed6aab6ae793bf5d079d3f5d20a79a9444d371425"));
        assert(genesis.hashMerkleRoot == uint256S("0xf5a4a30759ab0fd25be332231c1259b1adefe4a70e7cedba1a7bb6a724536bad"));
