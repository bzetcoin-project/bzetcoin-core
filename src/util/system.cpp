...
const char * const BITCOIN_CONF_FILENAME = "bzetcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bzetcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Bzetcoin";
#else
    // Unix-like
    return pathRet / ".bzetcoin";
#endif
#endif
}
