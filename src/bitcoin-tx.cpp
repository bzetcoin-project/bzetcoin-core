...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bzetcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bzetcoin-tx [options] <hex-tx> [commands]  Update hex-encoded bzetcoin transaction\n" +
            "or:     bzetcoin-tx [options] -create [commands]   Create hex-encoded bzetcoin transaction\n" +
            "\n";
