Contributing to Bzetcoin Core
============================

The Bzetcoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Bzetcoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/bzetcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to bzetcoin-qt
...
The following applies to code changes to the Bzetcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Bzetcoin
Network Protocol consensus changes.

Whether a pull request is merged into Bzetcoin Core rests with the project merge
...
Patches that change Bzetcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bzetcoin consensus, it must have been
...
The project leader is the release manager for each Bzetcoin Core release.
