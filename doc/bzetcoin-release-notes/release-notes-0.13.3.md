Bzetcoin Core version 0.13.3 is now available from:

  <https://download.bzetcoin.com/bzetcoin-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/bzetcoin-project/bzetcoin-coreblob/0.13/src/chainparams.cpp#L214).
