# Support for Output Descriptors in Bzetcoin Core

Since Bzetcoin Core v0.17, there is support for Output Descriptors. This is a
...
existing Bzetcoin Core wallets, a convenience function `combo` is
